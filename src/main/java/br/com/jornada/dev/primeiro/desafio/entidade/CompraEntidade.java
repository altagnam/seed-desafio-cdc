...
public class CompraEntidade {
	 ...
	 * @param pais
	 */
	public CompraEntidade(@Email @NotBlank String email, @NotBlank String nome, @NotBlank String sobreNome,
			...
			@NotNull PaisEntidade pais, Function<CompraEntidade, PedidoEntidade> funcaoCriacaoPedido) {
		super();
		this.email = email;
		this.nome = nome;
