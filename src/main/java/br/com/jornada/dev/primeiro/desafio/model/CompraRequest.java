...
public class CompraRequest {
	...
	/**
	 * Retorna uma instancia valida de {@link CompraEntidade}
	 * @param paisRepositorio
	 * @param estadoRepositorio
	 * @return
	 */
	public CompraEntidade toEntidade(final PaisRepositorio paisRepositorio, final EstadoRepositorio estadoRepositorio, final LivroRepositorio livroRepositorio) {
		...
		Function<CompraEntidade, PedidoEntidade> funcaoCriacaoPedido = getPedido().toEntidade(livroRepositorio);
		return new CompraEntidade(email, nome, sobreNome, documento, endereco, complemento, cidade, telefone, cep, estadoEncontrado, paisEncontrado, funcaoCriacaoPedido);		
